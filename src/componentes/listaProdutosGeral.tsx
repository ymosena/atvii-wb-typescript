        ...
        return (
            <div className="container">
                ...
                <div className="row">
                    ...
                    <ul className="tabs">
                        <li className="tab col s3"><a onClick={(e) => this.props.seletorView('PMaisConsumidoG', e)}>Mais Consumidos Geral</a></li>
                        <li className="tab col s3"><a onClick={(e) => this.props.seletorView('PMaisConsumidoGe', e)}>Mais Consumidos Gênero</a></li>
                    </ul>
                    </div>
                </div>
