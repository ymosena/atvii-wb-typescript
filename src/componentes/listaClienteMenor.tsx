...
export default class ListaClienteMenorConsumo extends Component<Props> {
  render() {
          ...
          <div className="col s12">
            <ul className="tabs">
              <li className="tab col s3">
                <a onClick={(e) => seletorView("MaiorConsumoQtd", e)}>
                  Maior Consumo Qtd
                </a>
              </li>
              <li className="tab col s3">
                <a onClick={(e) => seletorView("MaiorConsumoValor", e)}>
                  Maior Consumo Valor
                </a>
              </li>
              <li className="tab col s3">
                <a onClick={(e) => seletorView("MaiorConsumoGenero", e)}>
                  Maior Consumo Gênero
                </a>
              </li>
              <li className="tab col s3">
                <a onClick={(e) => seletorView("MenorConsumo", e)}>
                  Menor Consumo
                </a>
              </li>
            </ul>
